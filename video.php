...
if(isset($_POST['update']))
{
    ...
    $description_short= $_POST["address"];
    $image = addslashes(file_get_contents($_FILES["image"]["tmp_name"]));

    $sql = "INSERT INTO videos ( `video_title`,`video_desc`, `video_address`,`video_image`) VALUES ( '$title', '$description',
'$description_short','$image')";
 ...
 ?>
    ...
    <div class="container my-4">
        ...
        <form action="video.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="validationDefault01" class="form-label">Video URL</label>
                <input type="text" class="form-control" id="validationDefault01" name="address"
                    placeholder="Enter the Embedded Address of the Video" required>
            </div>


            <div class="mb-3">
                <label for="validationDefault01" class="form-label">Choose a Image to Upload</label>
                <input type="file" class="form-control" id="validationDefault01" name="image"
                    required>
            </div>
